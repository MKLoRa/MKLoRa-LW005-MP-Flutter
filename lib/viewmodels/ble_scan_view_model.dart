...
class BleScanViewModel extends ChangeNotifier {
  ...
  final _advServiceUuid = '0000aa04-0000-1000-8000-00805f9b34fb';
  ...
  Lw005DeviceSession? _connectedSession;

  Lw005DeviceSession? get connectedSession => _connectedSession;
  ...
  Future<Lw005DeviceSession> connectDevice({
    required BuildContext context,
    ...
    final granted = await _requestPermissions(context);
    if (!granted) {
      throw Lw005ProtocolException('Please allow Bluetooth connect permission first.');
    }
