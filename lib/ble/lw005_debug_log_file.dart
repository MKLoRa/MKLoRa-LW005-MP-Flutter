...
/// Persists debugger logs under `{appDocuments}/LW005/logs/{mac}/` (native LogDataActivity).
class Lw005DebugLogFile {
  Lw005DebugLogFile._();
  ...
  static Future<List<Lw005DebugLogEntry>> listLogs(String mac) async {
    ...
    return files.map((file) {
      ...
      return Lw005DebugLogEntry(name: name, path: file.path);
    }).toList();
  }
  ...
  static Future<void> deleteLogs(List<Lw005DebugLogEntry> entries) async {
