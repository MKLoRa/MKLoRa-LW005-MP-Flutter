class Lw005DisconnectEvent {
  const Lw005DisconnectEvent({
    required this.type,
  ...
  static Lw005DisconnectEvent? fromNotificationBytes(List<int> value) {
    if (value.length < 5) {
      return null;
    }
  ...
  static const generic = Lw005DisconnectEvent(
    type: 0,
