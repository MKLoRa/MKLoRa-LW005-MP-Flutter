import 'lw005_data_codec.dart';

/// In-memory export cache (mirrors native LoRaLW005MokoSupport.exportDatas).
class Lw005ExportDataStore {
  ...
  void appendRecords(List<Lw005ExportRecord> batch, {required bool insertAtHead}) {
  ...
  String _formatRecord(Lw005ExportRecord record) {
